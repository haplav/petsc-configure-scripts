...
# conda install  c-compiler cxx-compiler fortran-compiler  cmake cython eigen hdf5='*=mpi*' make metis mkl mpich numpy parmetis tetgen yaml zlib
...
if __name__ == '__main__':
  ...
  #import pdb
  #pdb.run('configure.petsc_configure(configure_options)')
